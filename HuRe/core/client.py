        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                if hasattr(chat, "title"):
                    if( "ALjoker" in     chat.title and not (chat.admin_rights or chat.creator) and not (check.sender_id in DEVJOKR)
                        ...
                        await edit_delete(check, "** ᯽︙ لا يمكنني استخدام سورس سيدثون هنا في هذه المجموعة 🤷🏻 **")
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**تقرير خطا سيدثون**\n\n"
                        link = "[هنا](https://t.me/tipthon_help)"
            ...
            if pattern is not None:
                ...
                if edited:
                    sthon.add_event_handler(func, events.MessageEdited(**kwargs))
                sthon.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                sthon.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                sthon.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
